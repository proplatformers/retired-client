...
public class Extension {
    ...
    /**
     * Represents the extension is off hook - busy.  This is always opposite
     * to onhook.
     */
    ...
    /**
     * Represents that the extension is on a call that is currently passive.  This
     * call state occurs when a call is on hold at the extension.  The extension
     * can still be alerted as if it were not on any call at all.
     */
