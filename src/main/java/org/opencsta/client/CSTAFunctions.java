...
/**
 * CSTAFunctions is the highest level interface which all CSTAClient objects
 * implement to get any CSTA functionality going.
 * 
 * 
 * @author chrismylonas
 */
public interface CSTAFunctions {
	 ...
	 * 
	 * @param device
	 *            The device where the call is to be retrieved from
	 * @param call_id
	 *            The call to be retrieved
	 */
	 ...
	 * 
	 * @param device
	 *            The hanging up device
	 * @param call_id
	 *            The call to be hung up or cleared
	 */
	 ...
	 * 
	 * @param device
	 *            Device on which monitor is to be on
	 */
	 ...
	 * 
	 * @param dev
	 *            The device the logical i/o link comes to
	 * @param code
	 *            The code pressed [0-9]
	 * @param data
	 *            The data sent max length 24
	 */
	public void TDSDataReceived(String dev, String code, String data);

	/**
	 * The Telephone Data Service received data gets pumped through this method.
	 * If the transmission is cut short however after the code is entered and no
	 * data sent this method is called instead.
	 * 
	 * 
	 * @param dev
	 *            The device the logical i/o link comes to
	 ...
	 * 
	 * @param device1
	 *            The device to set display on
	 * @param text
	 *            The text to display
	 * @param beep
	 *            Whether or not to beep on delivery
	 */
	 ...
	 * 
	 * @param deviceFrom
	 *            The place the call is at now but wants to transfer
	 * @param deviceTo
	 *            The destination where the call will go
	 * @param call_id
	 *            The call that is being transferred
	 */
	public void TransferCall(String deviceFrom, String deviceTo, String call_id);

	/**
	 * Deflect (divert) a call that is alerting queued or failed to another
	 * destination.
	 * 
	 * 
	 * @param deviceFrom
	 *            The device to deflect from
	 * @param deviceTo
	 *            The device to deflect to
	 * @param call_id
	 *            The call_id of the call
	 */
	public void DeflectCall(String deviceFrom, String deviceTo, String call_id);

	/**
	 * Notify the server that the TDS is to be instantiated and that this client
	 * is requesting it.
	 * 
	 */
